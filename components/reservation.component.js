...
class AppointmentApp extends Component {
  ...
  //   var len = axios.get('https://dine-out-syracuse.herokuapp.com/restreservations').then(response =>response.data.length)
    
  //  var length = await len
   
  //   console.log({userID: "1", restID: ID, slot_date: newAppointment.slot_date,slot_time:newAppointment.slot_time,count:length+1})
    // console.log(newAppointment);
   var length = 0
    axios
      .post('https://dine-out-syracuse.herokuapp.com/restreservations', {userID: "1", restID: ID, slot_date: newAppointment.slot_date,slot_time:newAppointment.slot_time,count:length+1})
      .then(response =>
        this.setState({
